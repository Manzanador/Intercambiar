...
#Enseña intentos de login fallidos almacenados en /var/log/btmp paginados
...
#Pagina y muestra el contenido del archivo de auditoria en el que mariadb almacena las transacciones realizadas en la BD. Configuracion encontrada en el archivo de configuracion de mariadb /etc/my.cnf.d/mariadb-server.cnf
...
#Muestra el historial de comandos ejecutados almacwenado en /var/log/secure filtrado para ver solo los comando relacionados a la manipulacion de usuarios y paginado
...
#Muestra el historial de comandos ejecutados almacwenado en /var/log/secure filtrado para ver solo los comando relacionados a la manipulacion de grupos y paginado
...
#Enseña el contenido paginado del archivo /var/log/CreacionRespaldos.log, el cual se llena automaticamente al utilizar el script de respaldos para realizar respaldos
...
#Enseña el contenido paginado del archivo /var/log/RecuperacionRespaldos.log, el cual se llena automaticamente al utilizar el script de respaldos para recuperar respaldos
...
then
#Muestra las ultimas 20 lineas del historial de comandos del usuario ingresado paginadas
